            ...
            <div className="divide-y divide-divider">
              {items.map((it, i) => (
                <div key={i} className="flex items-center gap-3 px-5 py-3.5">
                  <span className="w-6 h-6 rounded-full bg-success/10 flex items-center justify-center shrink-0">
                    <Check className="w-3.5 h-3.5 text-success-ink" strokeWidth={3} />
                  </span>
                  <div className="min-w-0 flex-1">
                    <div className="text-sm font-bold text-ink truncate">{it.name}</div>
