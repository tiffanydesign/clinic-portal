...
export const KPI_CONFIG: Record<Role, RoleKpiConfig> = {
  ...
  Admin: {
    ...
    pool: [
      {
        id: "checked-in-now", label: "Checked In Now", kind: "live", route: "/dashboard",
  ...
  Reception: {
    locked: [
      {
        id: "arrivals-expected", label: "Arrivals Expected", kind: "period",
        desc: "Patients expected to arrive in the period.",
        byRange: {
          today: { value: "14", deltaText: "3 vs last Friday", trend: "up", spark: [10, 12, 11, 13, 12, 11, 14] },
          "7d": { value: "88", deltaText: "5 vs previous 7 days", trend: "up", spark: [75, 78, 80, 82, 85, 84, 83, 88], label: "Arrivals" },
          "30d": { value: "365", deltaText: "10 vs previous 30 days", trend: "up", spark: [330, 340, 345, 350, 358, 365], label: "Arrivals" },
        },
      },
      {
        id: "checked-in", label: "Checked In", kind: "period",
        desc: "Patients checked in during the period.",
        byRange: {
          today: { value: "6", deltaText: "1 vs last Friday", trend: "up", spark: [4, 5, 4, 5, 5, 5, 6] },
          "7d": { value: "41", deltaText: "3 vs previous 7 days", trend: "up", spark: [32, 34, 35, 37, 38, 39, 38, 41] },
          "30d": { value: "176", deltaText: "8 vs previous 30 days", trend: "up", spark: [155, 160, 165, 168, 172, 176] },
        },
      },
    ],
    pool: [
      {
        id: "in-clinic-now", label: "In Clinic Now", kind: "live",
        desc: "Patients currently inside the clinic.",
        byRange: {
          today: { value: "5", deltaText: "1 vs last Friday", trend: "up", spark: [3, 4, 4, 5, 4, 5, 5] },
          "7d": { value: "5", deltaText: "avg 4.4 over period", trend: "flat", informational: true, spark: [3.8, 4, 4.2, 4.3, 4.5, 4.4, 4.6, 4.4] },
          "30d": { value: "5", deltaText: "avg 4.2 over period", trend: "flat", informational: true, spark: [3.9, 4.0, 4.1, 4.2, 4.2, 4.2] },
        },
      },
      {
        id: "unpaid-balances", label: "Unpaid Balances", kind: "live", inverse: true, route: "/billing",
        desc: "Appointments with outstanding balances.",
        byRange: {
          today: { value: "3", deltaText: "1 vs last Friday", trend: "down", spark: [5, 4, 4, 3, 4, 3, 3] },
          "7d": { value: "3", deltaText: "avg 3.6 over period", trend: "flat", informational: true, spark: [4.5, 4.2, 4.0, 3.8, 3.7, 3.6, 3.8, 3.6] },
          "30d": { value: "3", deltaText: "avg 4.1 over period", trend: "flat", informational: true, spark: [4.8, 4.6, 4.4, 4.3, 4.2, 4.1] },
        },
      },
      {
        id: "awaiting-checkin", label: "Awaiting Check In", kind: "live",
        desc: "Patients arrived but not yet checked in.",
        byRange: {
          today: { value: "3", deltaText: "0 vs last Friday", trend: "flat", spark: [2, 3, 2, 3, 3, 2, 3] },
          "7d": { value: "3", deltaText: "avg 2.6 over period", trend: "flat", informational: true, spark: [2.4, 2.5, 2.6, 2.7, 2.5, 2.6, 2.7, 2.6] },
          "30d": { value: "3", deltaText: "avg 2.8 over period", trend: "flat", informational: true, spark: [2.9, 2.8, 2.9, 2.8, 2.7, 2.8] },
        },
      },
      {
        id: "walk-ins", label: "Walk Ins", kind: "period",
        desc: "Unscheduled walk-in patients in the period.",
        byRange: {
          today: { value: "2", deltaText: "1 vs last Friday", trend: "up", spark: [0, 1, 1, 2, 1, 1, 2] },
          "7d": { value: "9", deltaText: "2 vs previous 7 days", trend: "up", spark: [5, 6, 6, 7, 8, 7, 8, 9] },
          "30d": { value: "34", deltaText: "6 vs previous 30 days", trend: "up", spark: [22, 25, 27, 29, 31, 34] },
        },
      },
    ],
