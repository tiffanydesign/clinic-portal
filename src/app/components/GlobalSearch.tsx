    ...
    <div className="relative w-full" ref={rootRef}>
      ...
      {trimmed && (
        <button
          ...
          className="absolute right-1.5 top-1/2 -translate-y-1/2 p-1.5 text-ink-muted hover:text-ink-soft rounded-control"
        >
      ...
      {open && trimmed && (
        <div className="absolute left-0 top-full mt-1 w-80 bg-surface border border-divider rounded-card shadow-xl z-50 max-h-[420px] overflow-y-auto py-1">
